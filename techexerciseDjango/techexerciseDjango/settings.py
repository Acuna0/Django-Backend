"""
Django settings for techexerciseDjango project.
...
SECRET_KEY = 'django-insecure-09go2xwtb!u3r*p@e0ak^kmzzprk=@&!t!j+4gx&flke2)52+o'
...
ROOT_URLCONF = 'techexerciseDjango.urls'
...
WSGI_APPLICATION = 'techexerciseDjango.wsgi.application'
